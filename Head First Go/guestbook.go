...
// viewGuestbookHandler reads guestbook signatures and displays them together with a count of all signatures.
func viewGuestbookHandler(writer http.ResponseWriter, request *http.Request) {
...
// getStrings returns a slice of strings reads from fileName, one string per line.
...
func main() {
	http.HandleFunc("/guestbook", viewGuestbookHandler)
